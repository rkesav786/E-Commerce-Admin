  ...
  return (
    <div className="container mt-5">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2>Fashion Sections</h2>
        <Link to="/fashion-section/create" className="btn btn-primary">
          Create New
        </Link>
      </div>
            ...
            <tbody>
              {catalogues.map((catalogue, index) => (
                <tr key={catalogue._id}>
                  ...
                  <td>
                    <Link
                      to={`/fashion-section/${catalogue._id}`}
...
export default FashionSectionIndex;
